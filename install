...
class Installer(object):
    ...
    def __init__(self, **kwargs):
        ...
        self.reporter = (
            kwargs.get('reporter', None) or (lambda s: None))
        self.debug_reporter = (
            kwargs.get('debug_reporter', None) or (lambda s: None))
    ...
    def dictmerge(self, basedict, newdict):
        """ Merge to dicts and return the result.
            ...
            d =  {1: True, 3: False, 4: {'a': True, 'c': False}}
            d2 = {2: True, 3: True, 4: {'b': True, 'c': True}}
            d3 = dictmerge(d, d2)
            d3 == {1: True, 2: True, 3: True, 4: {'a':True, 'b': True, 'c': True}}
        """
        merged = {}
        for k in basedict:
            v = basedict[k]
    ...
    def install_exes(self):
        ...
        for exepath in exes:
            ...
            try:
                ...
                if env_path and (not linkdir in env_path):
                    self.report('\n'.join((
    ...
    def remove_files(self, files):
        """ Deletes/removes a list files and directories.
            If an item is determined to be a directory, shutil.rmtree() is used.
            For files, os.remove() is used.
            Returns number of files that errored while removing.
        """
